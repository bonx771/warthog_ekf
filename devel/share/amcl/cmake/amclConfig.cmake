...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/cuong/warthog_ekf/src/navigation/amcl)
  set(amcl_DEVEL_PREFIX /home/cuong/warthog_ekf/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/cuong/warthog_ekf/install)
...
if(NOT "/home/cuong/warthog_ekf/devel/include;/home/cuong/warthog_ekf/src/navigation/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/cuong/warthog_ekf/devel/include;/home/cuong/warthog_ekf/src/navigation/amcl/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cuong/warthog_ekf/src/navigation/amcl/${idir}'.  ${_report}")
    endif()
