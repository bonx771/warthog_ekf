...
if("TRUE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/cuong/warthog_ekf/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/cuong/warthog_ekf/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/cuong/warthog_ekf/install)
...
if(NOT "/home/cuong/warthog_ekf/devel/include;/home/cuong/warthog_ekf/src/navigation/navfn/include " STREQUAL " ")
  set(navfn_INCLUDE_DIRS "")
  set(_include_dirs "/home/cuong/warthog_ekf/devel/include;/home/cuong/warthog_ekf/src/navigation/navfn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cuong/warthog_ekf/src/navigation/navfn/${idir}'.  ${_report}")
    endif()
