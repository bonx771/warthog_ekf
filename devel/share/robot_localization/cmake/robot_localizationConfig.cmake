...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/cuong/warthog_ekf/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/cuong/warthog_ekf/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/cuong/warthog_ekf/install)
...
if(NOT "/home/cuong/warthog_ekf/devel/include;/home/cuong/warthog_ekf/src/robot_localization/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/cuong/warthog_ekf/devel/include;/home/cuong/warthog_ekf/src/robot_localization/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cuong/warthog_ekf/src/robot_localization/${idir}'.  ${_report}")
    endif()
