...
if("TRUE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /home/cuong/warthog_ekf/src/navigation/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /home/cuong/warthog_ekf/devel)
  ...
  set(rotate_recovery_INSTALL_PREFIX /home/cuong/warthog_ekf/install)
...
if(NOT "/home/cuong/warthog_ekf/src/navigation/rotate_recovery/include " STREQUAL " ")
  set(rotate_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/cuong/warthog_ekf/src/navigation/rotate_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cuong/warthog_ekf/src/navigation/rotate_recovery/${idir}'.  ${_report}")
    endif()
